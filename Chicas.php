...
<div class="container-fluid">
  <nav class="navbar navbar-expand-lg bg-warning">
    ...
    <a href="historial.php" class="p-4 justify-content-center"><button class="historial">Ver Historial de Cambios</button></a>
    <a href="index.php" class="p-4 justify-content-center"><button>Regresar</button></a>
          </div>
</body>
</html>
